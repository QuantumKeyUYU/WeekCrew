...
/**
 * Здесь только TypeScript/JS — никаких @tailwind, @layer и прочего CSS.
 * Вся глобальная стилизация лежит в globals.css.
 *
 * Эти классы — готовые “токены” для кнопок и плашек.
 */
