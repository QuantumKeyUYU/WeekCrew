...
export default function HomePage() {
  ...
  return (
    <main className="px-4 py-12 sm:py-16">
      <div className="mx-auto flex max-w-5xl flex-col space-y-16 sm:space-y-24">
        <motion.section
        ...
        >
          <div className="space-y-8">
            ...
            <div className="grid gap-3 border-t border-white/10 pt-5 text-left text-sm text-white/80 sm:grid-cols-3">
              {stats.map((stat) => (
                <div key={stat.label} className="rounded-2xl border border-white/10 bg-white/5 p-4 shadow-[0_10px_40px_rgba(4,6,20,0.45)]">
