...
export const Header = () => {
  ...
  return (
    // отступы такие же, как у app-shell
    <header className="sticky top-3 z-50 px-3 sm:top-4 sm:px-6">
      <div
        className={clsx(
          // header-shell — чтобы на мобиле ширина совпадала с контентом (есть в globals.css)
          'header-shell mx-auto w-full max-w-5xl rounded-full border px-3 py-2.5 sm:px-4',
      ...
      >
        {/* ВНУТРЕННЯЯ сетка:
            - на мобиле: колонка (логотип сверху, кнопки ниже)
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          {/* Правая часть: на мобиле встаёт под логотипом одной строкой/двумя, но не обрезается */}
